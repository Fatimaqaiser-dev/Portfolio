        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a
              href="/cv.pdf"
              download
              className="flex items-center gap-2 px-5 py-2 rounded-full border border-cyan-400 text-cyan-300 hover:bg-cyan-400 hover:text-black transition shadow-lg shadow-cyan-500/10"
            >
              <FaDownload />
              Download CV
            </a>
          ...
          <div className="md:hidden bg-[#05060a]/95 border-t border-cyan-500/10">
            ...
            <ul className="flex flex-col items-center gap-6 py-8 text-gray-300 font-medium">
              ...
              <a
                href="/cv.pdf"
                download
                className="flex items-center gap-2 px-5 py-2 rounded-full border border-cyan-400 text-cyan-300 hover:bg-cyan-400 hover:text-black transition"
              >
                <FaDownload />
                Download CV
              </a>
